...
const Header = () => {
  return (
    <div>
        ...
        <Navbar expand={false}>
  <Container >
    <Navbar.Brand href="/"><img id="myDIV" src={logo} height="45" alt=""/></Navbar.Brand>
    ...
    >
      <Offcanvas.Header closeButton>
        <Offcanvas.Title id="offcanvasNavbarLabel">
            <img id="myDIVy" src={logo} height="45" alt=""/> 
        </Offcanvas.Title>
      </Offcanvas.Header>
      <Offcanvas.Body>
        <Nav >
            <Row>
                <Col lg={5} xs={5}>
                <p style={{paddingTop:"9px" , color:"rgb(221, 9, 9)"}} >
                ...
                <Col lg={7} xs={7} className="mr-2" style={{textAlign:"right"}}>
                <NavLink className="navlink"  to="/">الرئيسية</NavLink>
                </Col>
            </Row>
            ...
            <Row>
                ...
                <Col lg={7} xs={7} className="mr-2" style={{textAlign:"right"}}>
                <NavLink className="navlink" to="/food">تاكل ايه ؟</NavLink>
                </Col>
            </Row>
            ...
            <Row>
                ...
                <Col lg={7} xs={8} className="mr-2" style={{textAlign:"right"}}>
                <NavLink className="navlink" to="/series">تشوف ايه ؟</NavLink>
                </Col>
            </Row>
            ...
            <Row>
                ...
                <Col lg={7} xs={8} className="mr-2" style={{textAlign:"right"}}>
                <NavLink className="navlink" to="/places"> تروح فين ؟</NavLink>
                </Col>
            </Row>
            ...
            <Row>
                ...
                <Col lg={7} xs={8} className="mr-2" style={{textAlign:"right"}}>
                <NavLink className="navlink" to="/quraan"> القران الكريم</NavLink>
                </Col>
            </Row>
            ...
            <Row>
                ...
                <Col lg={7} xs={8} className="mr-2" style={{textAlign:"right"}}>
                <NavLink className="navlink" to="/prays"> مواقيت الصلاة</NavLink>
                </Col>
            </Row>
            ...
            <Row>
                ...
                <Col lg={7} xs={8} className="mr-2" style={{textAlign:"right"}}>
                <NavLink className="navlink" to="/media"> مكتبة الميديا</NavLink>
                </Col>
            </Row>
            ...
            <Row>
                ...
                <Col lg={7} xs={8} className="mr-2" style={{textAlign:"right"}}>
                <NavLink className="navlink" to="/chat"> المساعد الشخصي</NavLink>
                </Col>
            </Row>
            ...
            <Row>
                ...
                <Col lg={7} xs={8} className="mr-2" style={{textAlign:"right"}}>
                <NavLink className="navlink" to="/suggestion"> اقتراحات</NavLink>
                </Col>
            </Row>
            ...
            <Row>
                ...
                <Col lg={7} xs={8} className="mr-2" style={{textAlign:"right"}}>
                <NavLink className="navlink" to="/info"> معلومة ع السريع</NavLink>
                </Col>
            </Row>
